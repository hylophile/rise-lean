...
# res = sp.solvers.solve((eq0, eq1, eq2, eq3, eq4, eq5, eq6, eq7, eq8, eq9, eq10, eq11, eq12, eq13, eq14, eq15, eq16, eq17, eq18, eq19, eq20, eq21, eq22, eq23, eq24, eq25, eq26, eq27, eq28, eq29,), (m_m_66, m_n_65, m_m_7, m_n_27, m_m_28, m_n_1, m_n_10, m_m_13, m_n_16, m_m_17, m_n_24, m_n_20, m_n_43, m_m_31, m_n_41, m_n_37, m_n_30, m_n_34, m_n_52, m_n_49, m_m_61, m_n_60, m_n_48, m_n_5,), dict=True)
res = sp.solvers.solve((eq2), (m_m_7, m_n_27, m_m_28), dict=True)
if len(res) != 1:
